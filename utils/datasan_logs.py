...
DataSan пишет свои логи в БД, а не в файл, поэтому многие тесты
(SM-02, SM-03, SM-07, SM-10) проверяют именно содержимое этой таблицы.
Тут — тонкая обёртка с типовыми запросами.
"""
